...
const styles = {
	base: "inline-flex h-fit items-center justify-center gap-2 py-2 px-3 text-sm font-semibold select-none rounded-md transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 disabled:text-slate-400 disabled:bg-slate-200 disabled:cursor-not-allowed",
	variant: {
